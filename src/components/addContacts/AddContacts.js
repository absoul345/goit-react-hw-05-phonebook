...
import phoneBookActoions from '../../redux/phoneBook/phoneBook-actions';
...
export class AddContacts extends Component {
  ...
  handleSubmit = e => {
    ...
    if (sameContact) {
      return alert(
        `Name ${this.state.name} or number ${this.state.number} are alredy in contacts`,
      );
    }
...
const mapDispachPhoneBook = dispatch => ({
  onSubmit: (name, number) =>
    dispatch(phoneBookActoions.addContacts(name, number)),
});
